   ...
   <div className="flex items-center gap-1.5">
    ...
    <Popover>
     <PopoverTrigger asChild>
      <button type="button" aria-label="AI tahlili va ma’lumotlar qayerda qayta ishlanishi haqida" className="-m-1.5 inline-flex size-7 items-center justify-center rounded-md text-amber-600 outline-none hover:bg-amber-50 focus-visible:ring-[3px] focus-visible:ring-ring/50">
       <Icon name="info" size={16}/>
      </button>
     </PopoverTrigger>
     <PopoverContent align="start" className="w-80 text-sm">
      <p className="flex items-center gap-2 font-medium"><Icon name="info" size={16} className="text-amber-600"/>Rozilik haqida</p>
