...
const files=['package.json','package-lock.json','build.mjs','server.mjs','server-config.mjs','server-storage.mjs','ai-service.mjs','src','tests','scripts','worker','migrations','docs','wrangler.jsonc','public/index.html','public/favicon.svg','public/brand-h.png','public/app.js','public/style.css','public/landing.html','public/landing.css','public/.assetsignore','Dockerfile','.dockerignore','.env.example','README.md','DEPLOYMENT.md','RELEASE-CHECK.md'];
