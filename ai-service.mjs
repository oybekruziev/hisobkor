...
export const analysisSchema = {
 ...
 properties:{
  ...
  issues:{type:'array',items:{type:'object',additionalProperties:false,properties:{title:{type:'string'},detail:{type:'string'},evidence:{type:'string'},action:{type:'string'}},required:['title','detail','evidence','action']}},
