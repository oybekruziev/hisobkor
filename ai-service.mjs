...
export const analysisSchema = {
 ...
 properties:{
  ...
  issues:{type:'array',items:{type:'object',additionalProperties:false,properties:{severity:{type:'string',enum:['conflict','warning','info']},title:{type:'string'},detail:{type:'string'},evidence:{type:'string'},location:nullable,action:{type:'string'}},required:['severity','title','detail','evidence','location','action']}},
